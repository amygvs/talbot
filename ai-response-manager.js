...
class AIResponseManager {
    ...
    // Method to call the Netlify function
    async callAIAPI(message) {
        try {
            const contextualMessage = this.profileManager.buildContextualMessage(message);
            console.log('AIResponseManager: Calling API with contextual message');
            ...
            console.log('AIResponseManager: API response data:', data);
    ...
    // Keep the simulation method for complete offline fallback
